(() => {
    ...
    let staticEl = document.querySelectorAll(".static");
    setTimeout(staticEl.forEach((element => {
        let prc = element.querySelector(".static__percent-numb");
    ...
    let timeForHide = 3e3;
    let navBar = document.querySelector(".fp-bullets");
